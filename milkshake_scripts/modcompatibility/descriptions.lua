...
descriptions.Collectibles = {
    ...
    [enums.Collectibles.GOLDEN_SHOVEL] = {
        ...
        zh_cn = {
            name = "金铲铲",
            description = "挖出1-2个金色箱子和一个随机的金色掉落物." ..
                "#{{LadderRoom}} 如果用于装饰性地砖，则打开vip商店.",
    ...
    [enums.Collectibles.SHATTERED_ORB] = {
        ...
        zh_cn = {
            ...
            book_of_virtues = "粉碎后，产生3个不同效果的随机元素灵火",
    ...
    [enums.Collectibles.PRISMATIC_DICE] = {
        ...
        zh_cn = {
            name = "棱镜骰子",
            description = "将房间中的道具拆分为两个质量较低的道具" ..
    ...
    [enums.Collectibles.LEVITICUS] = {
        ...
        zh_cn = {
            name = "利未记",
            description = "{{SoulHeart}} 须通过拾取魂心来充能" ..
                "#{{EternalHeart}} +1 永恒之心" ..
                "#{{AngelRoom}} 在Boss房战斗前使用该物品会让Boss死亡后奖励一个天使房道具" ..
                "#{{DevilRoom}} 如果之前进行了恶魔交易，天使房道具需要付费",
...
descriptions.Trinkets = {
    ...
    [enums.Trinkets.AMETHYST_SHARD] = {
        ...
        zh_cn = {
            name = "预言紫水晶",
            description = "{{SpiritOrb}}隐藏石头在被摧毁时有75%的几率掉落洞察之灵",
            double =
            "{{SpiritOrb}} 隐藏石头在被摧毁时有75%的几率掉落 {{ColorGold}}1-2 {{CR}}个落洞察之灵",
            triple =
            "{{SpiritOrb}} 隐藏石头在被摧毁时有75%的几率掉落 {{ColorGold}}2-3 {{CR}}个落洞察之灵",
        },
    },
    [enums.Trinkets.RUBY_SHARD] = {
        ...
        zh_cn = {
            name = "炼狱红宝石",
            description = "{{SpiritOrb}} 隐藏石头在被摧毁时有75%的几率掉落炼狱之灵",
            double =
            "{{SpiritOrb}} 隐藏石头在被摧毁时有75%的几率掉落 {{ColorGold}}1-2 {{CR}}炼狱之灵",
            triple =
            "{{SpiritOrb}} 隐藏石头在被摧毁时有75%的几率掉落 {{ColorGold}}2-3 {{CR}}炼狱之灵",
        },
    },
    [enums.Trinkets.TOURMALINE_SHARD] = {
        ...
        zh_cn = {
            name = "导电电气石",
            description = "{{SpiritOrb}} 隐藏石头在被摧毁时有75%的几率掉落雷电之灵",
            double =
            "{{SpiritOrb}} 隐藏石头在被摧毁时有75%的几率掉落{{ColorGold}}1-2 {{CR}}雷电之灵",
            triple =
            "{{SpiritOrb}} 隐藏石头在被摧毁时有75%的几率掉落 {{ColorGold}}2-3 {{CR}}雷电之灵",
        },
    },
    [enums.Trinkets.EMERALD_SHARD] = {
        ...
        zh_cn = {
            name = "德鲁伊翡翠",
            description = "{{SpiritOrb}} 隐藏石头在被摧毁时有75%的几率掉落生命之灵",
            double =
            "{{SpiritOrb}} 隐藏石头在被摧毁时有75%的几率掉落 {{ColorGold}}1-2 {{CR}}生命之灵",
            triple =
            "{{SpiritOrb}} 隐藏石头在被摧毁时有75%的几率掉落 {{ColorGold}}2-3 {{CR}}生命之灵",
        },
    },
    [enums.Trinkets.PERIDOT_SHARD] = {
        ...
        zh_cn = {
            name = "剧毒橄榄石",
            description = "{{SpiritOrb}} 隐藏石头在被摧毁时有75%的几率掉落猛毒之灵",
            double =
            "{{SpiritOrb}} 隐藏石头在被摧毁时有75%的几率掉落 {{ColorGold}}1-2 {{CR}}猛毒之灵",
            triple =
            "{{SpiritOrb}} 隐藏石头在被摧毁时有75%的几率掉落 {{ColorGold}}2-3 {{CR}}猛毒之灵",
        },
    },
    [enums.Trinkets.GARNET_SHARD] = {
        ...
        zh_cn = {
            name = "渎神石榴石",
            description = "{{SpiritOrb}} 隐藏石头在被摧毁时有75%的几率掉落亵渎之灵",
            double =
            "{{SpiritOrb}} 隐藏石头在被摧毁时有75%的几率掉落 {{ColorGold}}1-2 {{CR}}亵渎之灵",
            triple =
            "{{SpiritOrb}} 隐藏石头在被摧毁时有75%的几率掉落{{ColorGold}}2-3 {{CR}}亵渎之灵",
        },
    },
    [enums.Trinkets.ONYX_SHARD] = {
        ...
        zh_cn = {
            name = "荒野玛瑙",
            description = "{{SpiritOrb}}隐藏石头在被摧毁时有75%的几率掉落复仇之灵",
            double =
            "{{SpiritOrb}}隐藏石头在被摧毁时有75%的几率掉落{{ColorGold}}1-2 {{CR}}复仇之灵",
            triple =
            "{{SpiritOrb}}隐藏石头在被摧毁时有75%的几率掉落{{ColorGold}}2-3 {{CR}}复仇之灵",
        },
    },
    [enums.Trinkets.DIAMOND_SHARD] = {
        ...
        zh_cn = {
            name = "圣洁紫玛瑙",
            description = "{{SpiritOrb}} 隐藏石头在被摧毁时有75%的几率掉落神圣之灵",
            double =
            "{{SpiritOrb}}隐藏石头在被摧毁时有75%的几率掉落{{ColorGold}}1-2 {{CR}}神圣之灵",
            triple =
            "{{SpiritOrb}}隐藏石头在被摧毁时有75%的几率掉落{{ColorGold}}2-3 {{CR}}神圣之灵",
        },
    },
    [enums.Trinkets.SAPPHIRE_SHARD] = {
        ...
        zh_cn = {
            name = "激流蓝宝石",
            description = "{{SpiritOrb}}隐藏石头在被摧毁时有75%的几率掉落洪流之灵",
            double =
            "{{SpiritOrb}}隐藏石头在被摧毁时有75%的几率掉落{{ColorGold}}1-2 {{CR}}洪流之灵",
            triple =
            "{{SpiritOrb}}隐藏石头在被摧毁时有75%的几率掉落{{ColorGold}}2-3 {{CR}}洪流之灵",
        },
    },
    [enums.Trinkets.AMBER_SHARD] = {
        ...
        zh_cn = {
            name = "大地琥珀",
            description = "{{SpiritOrb}}隐藏石头在被摧毁时有75%的几率掉落巨岩之灵",
            double =
            "{{SpiritOrb}} 隐藏石头在被摧毁时有75%的几率掉落 {{ColorGold}}1-2 {{CR}}巨岩之灵",
            triple =
...
descriptions.Entities = {
    [BRENDA] = {
        ...
        zh_cn = {
            name = "精灵窖炉",
            description = "{{HalfSoulHeart}}用半魂心随机换取以下奖励:" ..
                "#{{SpiritOrb}} 一个随机的精灵宝珠" ..
                "#{{Burning}} 一个随机的元素魂火" ..
                "#{{Trinket}} 一个随机的玻璃或宝石饰品" ..
                "#{{Rune}} 一个随机魂石"
        },
    }
}
