MilkshakeVol1:AddModCompatibility("Retribution", function()
    local OrbsPerRetributionEntities = {
        ...
        { orb = MilkshakeVol1.enums.Orbs.RANDOM,  type = 15,  variant = 1873 },    -- curdle
        ...
        { orb = MilkshakeVol1.enums.Orbs.RANDOM,  type = 88,  variant = 0,    subtype = 183 }, -- stumbling boil
        { orb = MilkshakeVol1.enums.Orbs.POISON, type = 88,  variant = 1,    subtype = 183 }, -- stumbling gut
        { orb = MilkshakeVol1.enums.Orbs.RANDOM,  type = 88,  variant = 2,    subtype = 183 }, -- stumbling sack
        { orb = MilkshakeVol1.enums.Orbs.RANDOM,  type = 240, variant = 1873 },    -- wall writhe
        { orb = MilkshakeVol1.enums.Orbs.RANDOM,  type = 242, variant = 1873 },    -- blind writhe
        { orb = MilkshakeVol1.enums.Orbs.UNHOLY, type = 241, variant = 1873 },    -- rage writhe
        { orb = MilkshakeVol1.enums.Orbs.RANDOM,  type = 288, variant = 1873 },    -- huskie
