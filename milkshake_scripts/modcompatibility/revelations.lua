MilkshakeVol1:AddModCompatibility("REVEL", function()
    local OrbsPerRevelationsEntities = {
        ...
        { orb = MilkshakeVol1.enums.Orbs.RANDOM,   type = 476, variant = 541 },   -- drifty
        ...
        { orb = MilkshakeVol1.enums.Orbs.RANDOM,   type = 480, variant = 541 },   -- smolycephalus
        ...
        { orb = MilkshakeVol1.enums.Orbs.RANDOM,   type = 476, variant = 542 },   -- pucker
        ...
        { orb = MilkshakeVol1.enums.Orbs.RANDOM,   type = 488, variant = 541 },   -- brother bloody
        ...
        { orb = MilkshakeVol1.enums.Orbs.RANDOM,   type = 745, variant = 541 },   -- mother pucker
        ...
        { orb = MilkshakeVol1.enums.Orbs.RANDOM,   type = 764, variant = 541, subtype = 0 }, -- chicken
        ...
        { orb = MilkshakeVol1.enums.Orbs.RANDOM,   type = 925, variant = 543 },   -- skitterpill card
        { orb = MilkshakeVol1.enums.Orbs.RANDOM,   type = 449, variant = 541 },   -- smolycephalus for scale
