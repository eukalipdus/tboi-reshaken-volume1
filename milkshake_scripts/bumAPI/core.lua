...
local function BumFamiliarInit(_, familiar)
	if TSIL.Utils.Tables.IsIn(VANILLA_BUM_VARIANTS, familiar.Variant) then
		familiar:Remove()
		return
	end
...
require("milkshake_scripts.bumAPI.vanillaBums.bumbo")
require("milkshake_scripts.bumAPI.vanillaBums.bumFriend")
require("milkshake_scripts.bumAPI.vanillaBums.darkBum")
require("milkshake_scripts.bumAPI.vanillaBums.keyBum")
require("milkshake_scripts.bumAPI.vanillaBums.superBum")