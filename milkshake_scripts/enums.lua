...
enums.Collectibles = {
    ...
    SPECIAL_BRENDA_NATURE_WISP = Isaac.GetItemIdByName("BRENDA CUSTOM NATURE WISP"),
    SPECIAL_BRENDA_ELECTRIC_WISP = Isaac.GetItemIdByName("BRENDA CUSTOM ELECTRIC WISP"),
    ...
    SPECIAL_BRENDA_UNDEAD_WISP = Isaac.GetItemIdByName("BRENDA CUSTOM DEAD WISP"),
