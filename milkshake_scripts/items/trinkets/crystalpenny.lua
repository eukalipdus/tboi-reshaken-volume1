...
function CrystalPenny:PrePickupCollision(Pickup, Collider, _)
...
MilkshakeVol1:AddCallback(ModCallbacks.MC_PRE_PICKUP_COLLISION, CrystalPenny.PrePickupCollision, PickupVariant.PICKUP_COIN)
return CrystalPenny