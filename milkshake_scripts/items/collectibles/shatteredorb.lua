...
local OrbsPerEnemy = {
    ...
    {trinket=enums.Cards.RUBY_ORB, type=833, variant=0, },
...
local OrbsPerFiendFolioEntities = {
    ...
    {trinket=enums.Cards.SAPPHIRE_ORB, type=451, variant=250, },
    {trinket=enums.Cards.SAPPHIRE_ORB, type=451, variant=141, },
    {trinket=enums.Cards.SAPPHIRE_ORB, type=617, variant=402, },
    ...
    {trinket=enums.Cards.SAPPHIRE_ORB, type=195, variant=30},
